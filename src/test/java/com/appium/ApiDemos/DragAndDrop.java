...
public class DragAndDrop {
	...
	@Test
	public void apiDragAndDrop() throws MalformedURLException, InterruptedException {
		...
		MobileElement dest = (MobileElement) driver.findElement(By.id("io.appium.android.apis:id/drag_dot_2"));
		TouchAction touch=new TouchAction(driver);
		touch.longPress(src).waitAction().moveTo(dest).release().perform();
